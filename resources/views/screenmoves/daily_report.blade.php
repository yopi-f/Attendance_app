...
@section('content')
    ...
    <div class="d-flex justify-content-center flex-column align-items-center">
        ...
        <input type="date" value ="{{ $now->format("Y-m-d") }}" class="form-control w-25 my-3 rounded-lg">
        <div class="mt-3 badge bg-secondary notification badge" style="font-size:16px;">内容</div>
        <textarea placeholder="内容を入力してください。" rows="7" 
         class="form-control form-control-lg my-3 w-75  rounded-lg"></textarea>
         <button type="button" class="btn btn-primary my-2">送信</button> 
    </div>
@endsection